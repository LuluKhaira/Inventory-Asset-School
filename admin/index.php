            ...
            <div class="col-md-6 mb-4">
                <div class="card feature-card animate__animated animate__fadeInLeft">
                    <div class="card-body text-center">
                        ...
                        <a href="asset_list.php" class="btn btn-custom mt-3 text-natural">Lihat detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card feature-card animate__animated animate__fadeInUp">
                    <div class="card-body text-center">
                        ...
                        <a href="../admin/home_gedung.php" class="btn btn-custom mt-3 text-natural">Lihat detail</a>
                    </div>
                </div>
            </div>
